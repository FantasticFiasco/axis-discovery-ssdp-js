...
export class Device {
     ...
     * @param port The port.
     * @param macAddress The MAC address. In most situations this is identical to the serial
     * number. The exceptions are the Axis products which bundle multiple physical devices into a
     * single casing with a shared network interface. Because of the shared network interface they
