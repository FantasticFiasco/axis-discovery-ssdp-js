...
export const NETWORK_INTERFACES_WITH_INTERNAL_ADDRESSES: { [index: string]: os.NetworkInterfaceInfoIPv4[] } = {
    ...
    Ethernet2: [
        { address: '2.2.2.2', netmask: '255.0.0.0', family: 'IPv4', mac: '11:11:11:11:11:11', internal: true, cidr: '2.2.2.2/8' },
    ],
};
...
export const NETWORK_INTERFACES_WITH_IPV6_ADDRESSES: { [index: string]: os.NetworkInterfaceInfoIPv6[] } = {
    ...
    Ethernet2: [
        { address: '2222::2222:2222:2222:2222', netmask: 'ffff:ffff:ffff:ffff::', family: 'IPv6', mac: '22:22:22:22:22:22', scopeid: 6, internal: false, cidr: '2222::2222:2222:2222:2222/64' },
    ],
};
